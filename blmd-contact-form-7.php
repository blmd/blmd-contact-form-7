...
class BLMD_Contact_Form_7 {
	...
	public function init() {
		...
		register_post_type( 'wpcf7_wpce_item', array(
				'labels' => array(
					'name' => __( 'WPCF7 Items', 'blmd-contact-form-7' ),
					'singular_name' => __( 'WPCF7 Items', 'blmd-contact-form-7' ),
					'menu_name'  => __( 'View Submissions', 'blmd-contact-form-7' ) ),
				'public' => false,
...
function BLMD_Contact_Form_7() {
	return BLMD_Contact_Form_7::factory();
}
